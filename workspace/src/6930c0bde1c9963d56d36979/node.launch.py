...
def generate_launch_description():
    parameters = json.loads('{"joint":"6930c0ade1c9963d56d3696c","control_mode":"position","limit.lower_position":0,"limit.upper_position":360,"limit.position_step":1,"limit.max_effort":10,"limit.effort_step":null,"limit.max_velocity":35,"limit.velocity_step":0}')
    ...
    env = {
        "POLYFLOW_NODE_ID": "6930c0bde1c9963d56d36979",
    ...
    return LaunchDescription(
        [
            ExecuteProcess(
                cmd=["python3", "workspace/src/6930c0bde1c9963d56d36979/odrive-s1/node.py"],
                additional_env=env,
                output="screen",
            )
        ]
